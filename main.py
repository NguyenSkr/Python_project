...
root.title('Tkinter Hub (Student Managament System)')

bg_color = '#050c56'
red_btn = '#f32409'

image_path_student_login = os.path.join("images", "student.png")
image_student_login = Image.open(image_path_student_login)
image_student_login = image_student_login.resize((50, 60), Image.LANCZOS)
login_student_icon = ImageTk.PhotoImage(image_student_login)

image_path_admin = os.path.join("images", "admin.png")
image_admin = Image.open(image_path_admin)
image_admin = image_admin.resize((50, 60), Image.LANCZOS)
login_admin_icon = ImageTk.PhotoImage(image_admin)

image_path_add_student = os.path.join("images", "addstudent.png")
image_add_student = Image.open(image_path_add_student)
image_add_student = image_add_student.resize((50, 60), Image.LANCZOS)
add_student_icon = ImageTk.PhotoImage(image_add_student)

image_path_lock = os.path.join("images", "locked.png")
image_lock = Image.open(image_path_lock)
image_lock = image_lock.resize((40, 40), Image.LANCZOS)
lock_icon = ImageTk.PhotoImage(image_lock)

image_path_unlock = os.path.join("images", "unlocked.png")
image_unlock = Image.open(image_path_unlock)
image_unlock = image_unlock.resize((40, 40), Image.LANCZOS)
unlock_icon = ImageTk.PhotoImage(image_unlock)

image_path_stu_profile = os.path.join("images", "stuprofile.png")
image_stu_profile = Image.open(image_path_stu_profile)
image_stu_profile = image_stu_profile.resize((100,100), Image.LANCZOS)
stu_profile_icon = ImageTk.PhotoImage(image_stu_profile)

# login_student_icon = tk.PhotoImage(file='images/student.png', width=50, height=50)
...
"""
    ...
    student_card = Image.open('images/student_card_frame.png').convert('RGBA')
    pic = Image.open(student_pic_path).convert('RGBA')
    pic = pic.resize((90, 100), Image.LANCZOS)
    student_card.paste(pic, (15,25), pic)
...
def student_card_page(student_card_obj, bypass_login_page=False):
    ...
    print_student_card_btn = tk.Button(student_card_page_fm, text='🖨️', bg=bg_color, fg='white', font=('Bold',17),bd=1, command=print_student_card)
...
def sendmail_to_student(email, message, subject):
    ...
    smtp_connection = smtplib.SMTP(host=smtp_sever, port=smtp_port)
...
Do You Want to Continue?""")
    ...
    heading_lb = tk.Label(forget_password_page_fm, text='⚠️ Forgetting Password', bg=bg_color, fg='white', font=('Bold', 15))
    ...
    student_id_lb = tk.Label(forget_password_page_fm, text='Enter Student ID Number.', font=('Blod',13))
    ...
    info_lb = tk.Label(forget_password_page_fm, text="""Please Check Your Email Address
We will Send to you
...
def student_dashboard(student_id):
    ...
    student_card_btn = tk.Button(options_fm, text='Student\nCard', font=('Bold', 15), fg=bg_color, bg='#c3c3c3', bd=0, justify=tk.LEFT, command=lambda: switch(indicator=student_card_btn_indicator, page=dashboard_student_card_page))
    ...
    security_btn = tk.Button(options_fm, text='Security', font=('Bold', 15), fg=bg_color, bg='#c3c3c3', bd=0, command=lambda: switch(indicator=security_btn_indicator, page=security_page))
    ...
    edit_data_btn = tk.Button(options_fm, text='Edit Data', font=('Bold', 15), fg=bg_color, bg='#c3c3c3', bd=0, command=lambda: switch(indicator=edit_data_btn_indicator, page=edit_data_page))
    ...
    delete_account_btn = tk.Button(options_fm, text='Delete\nAccount', font=('Bold', 15), fg=bg_color, bg='#c3c3c3', bd=0, justify=tk.LEFT, command=lambda: switch(indicator=delete_account_btn_indicator, page=delete_account_page))
    ...
    def home_page():
        ...
        hello_lb = tk.Label(home_page_fm, text=f'!Hello {get_student_details[0][0]}', font=('Bold', 15))
        hello_lb.place(x=130, y=50)
...
"""
        ...
        student_card_image = ImageTk.PhotoImage(student_card_image_obj)

        student_card_page_fm = tk.Frame(pages_fm)
        
        card_lb = tk.Label(student_card_page_fm, image=student_card_image)
        card_lb.image = student_card_image
    ...
    def security_page():
        ...
        show_hide_btn = tk.Button(security_page_fm, image=lock_icon,bd=0, command=show_hide_password)
        show_hide_btn.place(x=280, y=70)

        change_password_lb = tk.Label(security_page_fm, text='Change Password', font=('Bold', 15), bg=red_btn, fg='white')
        ...
        new_password_ent = tk.Entry(security_page_fm, text='Set New Password', font=('Bold', 15), justify=tk.CENTER)
    ...
    def edit_data_page():
        ...
        def check_inputs():
            ...
            if student_name_ent.get() == '':
                student_name_ent.config(highlightcolor=red_btn, highlightbackground=red_btn)
                student_name_ent.focus()
                message_box(message='Student Full Name is Required')
            elif student_age_ent.get() == '':
                student_age_ent.config(highlightcolor=red_btn, highlightbackground=red_btn)
                student_age_ent.focus()
                message_box(message='Student Full Age is Required')
            elif student_contact_ent.get() == '':
                student_contact_ent.config(highlightcolor=red_btn, highlightbackground=red_btn)
                student_contact_ent.focus()
                message_box(message='Student Contact Number is Required')
            elif student_email_ent.get() == '':
                student_email_ent.config(highlightcolor=red_btn, highlightbackground=red_btn)
                ...
                cursor.execute(f"""
                UPDATE data SET name='{name}', age='{age}', class='{select_class}', phone_number='{contact_number}', email='{email_address}'             
        ...
        student_name_ent = tk.Entry(edit_data_page_fm,font=('Bold',15), highlightbackground='gray', highlightcolor=bg_color, highlightthickness=2)
        ...
        student_age_ent = tk.Entry(edit_data_page_fm,font=('Bold',15), highlightbackground='gray', highlightcolor=bg_color, highlightthickness=2)
        ...
        student_contact_ent = tk.Entry(edit_data_page_fm,font=('Bold',15), highlightbackground='gray', highlightcolor=bg_color, highlightthickness=2)
    ...
    def delete_account_page():
        ...
        delete_account_lb = tk.Label(delete_account_page_fm, text='⚠️Delete Account', font=('Bold',15), bg=red_btn, fg='white')
        delete_account_lb.place(x=30, y=100, width=290)

        delete_account_button = tk.Button(delete_account_page_fm, text='Delete Account', bg=red_btn, fg='white', font=('Bold', 13), command=confirm_delete_account)
...
def student_login_page():
    ...
    def login_account():
        ...
        if verify_id_number:
            ...
            if verify_password:
                ...
                password_ent.config(highlightcolor=red_btn, highlightbackground=red_btn)
                message_box(message='Incorrect Password')
        else:
            print('ID is Incorrect')
            id_number_ent.config(highlightcolor=red_btn, highlightbackground=red_btn)
    ...
    heading_lb.place(x=0, y=0, width=400)
    back_btn = tk.Button(student_login_page_fm, text='⬅️', font=('Bold', 20),fg=bg_color,bd=0, command=forward_to_welcome_page)
    back_btn.place(x=5, y=40)

    stud_icon_lb = tk.Label(student_login_page_fm, image=login_student_icon)
    stud_icon_lb.place(x=170, y=40)
    ...
    show_hide_btn = tk.Button(student_login_page_fm, image=lock_icon,bd=0, command=show_hide_password)
...
def admin_dashboard():
    ...
    home_btn = tk.Button(options_fm, text='Home', font=('Bold', 15), fg=bg_color, bd=0, bg='#c3c3c3', command=lambda: switch(indicator=home_btn_indicator, page=home_page))
    home_btn.place(x=10, y=50)
    ...
    announcement_btn = tk.Button(options_fm, text='Announce\n-Ment📢', font=('Bold', 15), fg=bg_color, bd=0, bg='#c3c3c3', justify=tk.LEFT, command=lambda: switch(indicator=announcement_btn_indicator, page=announcement_page))
    ...
    logout_btn = tk.Button(options_fm, text='Logout', font=('Bold', 15), fg=bg_color, bd=0, bg='#c3c3c3', command=logout)
    ...
    def find_student_page():
        ...
        def generate_student_card():
            ...
            # selected_id = record_table.item(item=selection, option='values')
            selected_id = record_table.item(selection[0], 'values')[0]
...
"""
    ...
    def announcement_page():
        ...
        for grade in class_list:
            ...
            class_check_btn.place(x=10, y=y_poisition)
            y_poisition += 25
...
def admin_login_page():
    ...
    heading_lb.place(x=0, y=0, width=400)
    back_btn = tk.Button(admin_login_page_fm, text='⬅️', font=('Bold', 20),fg=bg_color,bd=0, command=forward_to_welcome_page)
    back_btn.place(x=5, y=40)

    admin_icon_lb = tk.Label(admin_login_page_fm, image=login_admin_icon)
    admin_icon_lb.place(x=170, y=40)
    ...
    show_hide_btn = tk.Button(admin_login_page_fm, image=lock_icon,bd=0, command=show_hide_password)
    show_hide_btn.place(x=310, y=280)
...
class_list = ['TT','TI','TA','TC','TE','None']
def add_account_page():
    ...
    def check_input_validation():
        if student_name_ent.get() == '':
            ...
            account_password_ent.config(highlightcolor=red_btn, highlightbackground=red_btn)
            ...
            if pic_path.get() != '':
                ...
                read_data = open('images/stuprofile.png', 'rb')
                pic_data = read_data.read()
                read_data.close()
                pic_path.set('images/stuprofile.png')
...
"""
    ...
    add_pic_btn = tk.Button(add_pic_section_fm, image=stu_profile_icon,command=open_pic)
    add_pic_btn.pack()
    ...
    student_name_ent = tk.Entry(add_account_page_fm,font=('Bold',15), highlightbackground='gray', highlightcolor=bg_color, highlightthickness=2)
    student_name_ent.place(x=5, y=160, width=180)
    student_name_ent.bind('<KeyRelease>', lambda e: remove_highlight_warning(entry=student_name_ent))
    ...
    student_age_ent = tk.Entry(add_account_page_fm,font=('Bold',15), highlightbackground='gray', highlightcolor=bg_color, highlightthickness=2)
    ...
    student_contact_ent = tk.Entry(add_account_page_fm,font=('Bold',15), highlightbackground='gray', highlightcolor=bg_color, highlightthickness=2)
    ...
    id_info_lb = tk.Label(add_account_page_fm, text="""! Note: You Will Using This Auto Generate
ID Number To Login Account.""", justify=tk.LEFT)
    ...
    email_info_lb = tk.Label(add_account_page_fm, text="""! Note: Email Address Student
Can Recover Account
...
Student will get Future Notifications.""", justify=tk.LEFT)
    ...
    account_password_info_lb = tk.Label(add_account_page_fm, text="""! Note: Student Create Password
And Provided Student ID Number
Student Can Login Account""", justify=tk.LEFT)
    account_password_info_lb.place(x=240, y=345)

    home_btn = tk.Button(add_account_page_fm, text='Home', font=('Bold',15), bg=red_btn,fg='white', bd=0,command=forward_to_welcome_page)
